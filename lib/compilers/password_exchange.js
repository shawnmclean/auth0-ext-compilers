...
const compilerFactory = require('./compilerFactory');

module.exports = compilerFactory.createCompiler(passwordExchangeHandler);
...
function passwordExchangeHandler (func, webtaskContext, cb) {
    return Authz.is_authorized(webtaskContext, error => {
        ...
        if (typeof webtaskContext.body.user !== 'object') {
